...
## 1. What are the long-term tradeoffs of Schnorr?
...
## 2. Why is key tweaking a commitment, not encryption?
...
## 3. Key-path vs Script-path: what fundamentally changes?
...
## 4. What happens if Merkle sibling order changes?
